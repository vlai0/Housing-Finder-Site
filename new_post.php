...
<main class="new-post">
    ...
    <form class="new-post-apartment form-option" action="" method="POST" enctype="multipart/form-data">
        ...
        <p class="form-element">
            ...
            <label for="radRoommate"><input type="radio" id="radRoommate" name="radApartmentListingType" value="Apartment Roommate Request" required <?php if($apartmentListingType == "Apartment Roomate Request") { print "checked"; } ?>> Roommate Request</label>
        </p>
        <p class="form-element">
